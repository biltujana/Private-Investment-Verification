...
- ðŸ“„ **Project Proposal**: [PROPOSAL.md](PROPOSAL.md)
- ðŸ“¦ **GitHub Repository**: [https://github.com/biltujana/Private-Investment-Verification](https://github.com/biltujana/Private-Investment-Verification)
- ðŸŽ¥ **YouTube Video Walkthrough**: [https://youtu.be/V6r9VZ2xhIM](https://youtu.be/V6r9VZ2xhIM)
- âš™ï¸ **CI/CD Workflow**: [.github/workflows/ci.yml](.github/workflows/ci.yml)
- ðŸŒ **Midnight Explorer**: [https://preview.midnightexplorer.com/contracts/0x443a1a8b3dfcca0bc809e15fbee0160bfc3e9eb375cfee4f8383b8a3b2fcbaa2](https://preview.midnightexplorer.com/contracts/0x443a1a8b3dfcca0bc809e15fbee0160bfc3e9eb375cfee4f8383b8a3b2fcbaa2)
- ðŸ“¡ **Network**: Midnight Preview Testnet
- ðŸ”‘ **Contract Address**: `0x443a1a8b3dfcca0bc809e15fbee0160bfc3e9eb375cfee4f8383b8a3b2fcbaa2` âœ… **CONFIRMED**
- ðŸŒ **Preview Node RPC**: `https://rpc.preview.midnight.network`
- ðŸ“Š **Preview Indexer**: `https://indexer.preview.midnight.network/api/v4/graphql`
- ðŸ’§ **Preview Faucet**: `https://faucet.preview.midnight.network`

---

## âš¡ Smart Contract & Frontend Integration Architecture
...
## ðŸ“¸ Platform Screenshots & Verification
...
| Exact Net Worth Dollar Amount | `netWorthAmount()` | Proved â‰¥ $2.5M in ZK; exact wealth hidden |
...
## ðŸ“œ Compact Smart Contract (v2)
...
|---|---|---|---|---|
| 1 | `verifyInvestorEligibility` | `Bytes<32>` (fundId) | investorSecretKey, financialAuditProofHash, netWorthAmount, verificationProofNonce | ZK accredited investor proof asserting net worth â‰¥ threshold |
| 2 | `verifyInvestmentCommitment` | `Bytes<32>` (commitment) | â€” | Public on-chain investor accreditation verification |
...
| 5 | `resetInvestmentFund` | `Bytes<32>`, `Uint<32>` | â€” | Rotate fund offering ID + update criteria |
| 6 | `incrementSession` | â€” | â€” | Bump session nonce (replay protection across capital calls) |

```compact
pragma language_version 0.23;
import CompactStandardLibrary;

// â”€â”€ Ledger State (8 Public On-Chain Fields) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Private Witnesses (Never Disclosed On-Chain) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// Circuit 1: verifyInvestorEligibility â€” ZK Accredited Investor Proof
...
// Circuit 2: verifyInvestmentCommitment â€” Public On-Chain Verification
...
// Circuit 3: revokeInvestorAccreditation â€” Fund Manager Disqualification
...
// Circuit 4: setFundManagerCommitment â€” Anchor Manager Authority & Threshold
...
// Circuit 5: resetInvestmentFund â€” Rotate Fund Offering & Update Threshold
...
// Circuit 6: incrementSession â€” Nonce Rotation for Replay Protection
...
## ðŸ† Level 2 & Level 3 Verification Checklists
...
### Level 3 Checklist
- [x] **Rich Contract Logic (v2)**: 6 circuits directly implementing accredited investor logic â€” net worth threshold enforcement, manager authority anchoring, accreditation revocation, replay protection.
